			...
			<div class="row">
				...
				<div class="col-md-12 mg-bt-80">
					<div class="row portfolioContainer  text-center">
						...
						<div class="col-md-4 col-xs-6 portfolio-item <?php echo $port_grid_item['campanha']; ?>"> <a href="portfolio-item.php?campanha=<?php echo $port_grid_item['id']; ?>"> <span class="project-hover"> <span><strong><?php echo $port_grid_item['campanha']; ?></strong><br />
							<small><?php echo $port_grid_item['cliente']; ?></small> </span> </span> <img src="uploads/<?php echo $port_grid_item['foto']; ?>" alt="<?php echo $port_grid_item['campanha']; ?>"> </a> </div>
						<?php }?>
					</div>
				</div>
			</div>
