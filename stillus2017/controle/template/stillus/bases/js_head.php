...
<!-- TinyMCE -->
<script type="text/javascript" src="<?php echo u_TEMPLATE;?>assets/editor/tiny_mce.js"></script>
<script type="text/javascript" src="<?php echo u_TEMPLATE;?>assets/editor/plugins/tinybrowser/tb_tinymce.js.php"></script>
