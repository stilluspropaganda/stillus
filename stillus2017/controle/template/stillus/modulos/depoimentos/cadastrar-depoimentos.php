...
<?php if(isset($_POST['acao']) && $_POST['acao']=='cadastrar'){
	...
	$foto_titulo = 'depoimentos_'.date('YmdHis').'_'.$sis->slug($nome).'_'.$sis->slug($foto['name']);
	...
	if($upload){
		$campos = "
			...
			ordem='$ordem'
		";
		$add = $sis->insert("depoimentos",$campos);
		if($add > 0){
			$_POST = NULL;
	...
	<div class="container-fluid"> 
		...
		<div class="row-fluid">
			<div class="span12"> 
				...
				<h3 class="page-title"> Depoimentos <small>cadastro</small> </h3>
				<ul class="breadcrumb">
				...
				<div class="span12"> 
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<h4><i class="icon-reorder"></i>Cadastrar Depoimento</h4>
						</div>
						<div class="portlet-body form"> 
							...
							<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="commentForm">
								...
								<div class="form-actions span12">
									...
									<a href="<?php echo $sis->url_base()?>controle/depoimentos/listar-depoimentos" class="btn pull-right">Voltar</a>
								</div>
							</form>
							<!-- END FORM--> 
						</div>
