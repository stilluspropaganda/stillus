<?php if($url3){
	...
	echo'<script>window.location.href="'.$sis->url_base().'controle/depoimentos/listar-depoimentos";</script>';
	exit;
}?>
<!-- BEGIN PAGE -->
...
<?php if(isset($_POST['acao']) && $_POST['acao']=='cadastrar'){
	...
	$foto_titulo = 'depoimentos_'.date('YmdHis').'_'.$sis->slug($titulo).'_'.$sis->slug($foto['name']);
	...
	$update = $sis->update("depoimentos",$campos,"id",$id);
	if($update){
		$_POST = NULL;
...
$itens = $sis->select("depoimentos",NULL,NULL,"id='".$id."'");
	...
	<div class="container-fluid"> 
		...
		<div class="row-fluid">
			<div class="span12"> 
				...
				<h3 class="page-title"> Depoimentos <small>edição</small> </h3>
				<ul class="breadcrumb">
				...
				<div class="span12"> 
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<h4><i class="icon-reorder"></i>Editar depoimentos</h4>
						</div>
						<div class="portlet-body form"> 
							...
							<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" id="commentForm">
								...
								<div class="form-actions">
									...
									<a href="<?php echo $sis->url_base()?>controle/depoimentos/listar-depoimentos" class="btn">Voltar</a>
								</div>
							</form>
							<!-- END FORM--> 
						</div>
